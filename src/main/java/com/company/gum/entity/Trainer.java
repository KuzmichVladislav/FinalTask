...
public class Trainer extends User {
	...
	public boolean equals(Object o) {
		...
		if (getRegisterDate() != null ? !getRegisterDate().equals(trainer.getRegisterDate())
				: trainer.getRegisterDate() != null)
			return false;
		...
		if (getMail() != null ? !getMail().equals(trainer.getMail()) : trainer.getMail() != null)
			return false;
		if (getDescription() != null ? !getDescription().equals(trainer.getDescription())
				: trainer.getDescription() != null)
			return false;
		return getExperience() != null ? getExperience().equals(trainer.getExperience())
				: trainer.getExperience() == null;
	}
	...
	public static final class Builder {
		...
		/**
		 * Sets the {@code description} and returns a reference to this Builder so that
		...
		/**
		 * Sets the {@code experience} and returns a reference to this Builder so that
		 * the methods can be chained together.
		 *
