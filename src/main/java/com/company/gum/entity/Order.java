...
public class Order extends AbstractEntity {
	...
	public enum OrderStatus {
		NEW, REVIEWED, REJECTED, ACCEPTED, IN_PROCESSING, TERMINATED
	}
	...
	public static final class Builder {
		...
		/**
		 * Sets the {@code clientId} and returns a reference to this Builder so that the
		 * methods can be chained together.
		 *
		...
		/**
		 * Sets the {@code clientName} and returns a reference to this Builder so that
		...
		/**
		 * Sets the {@code clientSurname} and returns a reference to this Builder so
		...
		/**
		 * Sets the {@code trainerId} and returns a reference to this Builder so that
		 * the methods can be chained together.
		 *
		...
		/**
		 * Sets the {@code trainerName} and returns a reference to this Builder so that
		 * the methods can be chained together.
		 *
		...
		/**
		 * Sets the {@code trainerSurname} and returns a reference to this Builder so
		 * that the methods can be chained together.
		 *
		...
		/**
		 * Sets the {@code exercises} and returns a reference to this Builder so that
		 * the methods can be chained together.
		 *
		...
		/**
		 * Sets the {@code nutrition} and returns a reference to this Builder so that
		 * the methods can be chained together.
		 *
		...
		/**
		 * Sets the {@code startDate} and returns a reference to this Builder so that
		 * the methods can be chained together.
		 *
		...
		/**
		 * Sets the {@code endDate} and returns a reference to this Builder so that the
		 * methods can be chained together.
		 *
		...
		/**
		 * Sets the {@code price} and returns a reference to this Builder so that the
		 * methods can be chained together.
		 *
		...
		/**
		 * Sets the {@code clientComment} and returns a reference to this Builder so
		 * that the methods can be chained together.
		 *
		...
		/**
		 * Sets the {@code orderStatus} and returns a reference to this Builder so that
		 * the methods can be chained together.
		 *
		...
		/**
		 * Sets the {@code active} and returns a reference to this Builder so that the
		 * methods can be chained together.
		 *
		...
		/**
		 * Sets the {@code duration} and returns a reference to this Builder so that the
		 * methods can be chained together.
		 *
