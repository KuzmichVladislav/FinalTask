...
public class CommandFilter implements Filter {
     ...
     * The role enum map.
     */
    private final EnumMap<User.UserRole, EnumSet<CommandType>> roleEnumMap = new EnumMap<>(User.UserRole.class);

    /**
     * The command types of guest.
     */
    EnumSet<CommandType> commandTypesOfGuest = EnumSet.of(REGISTER,
            VERIFICATION,
            CHANGE_LOCALE,
            LOGIN);
     ...
     */
    EnumSet<CommandType> commandTypesOfClient = EnumSet.of(
            CHANGE_LOCALE,
            LOGOUT,
            UPLOAD_IMAGE,
            EDIT_CLIENT_PROFILE,
     ...
     */
    EnumSet<CommandType> commandTypesOfTrainer = EnumSet.of(
            VERIFICATION,
            CHANGE_LOCALE,
            LOGOUT,
            UPLOAD_IMAGE,
     ...
     */
    EnumSet<CommandType> commandTypesOfAdmin = EnumSet.of(
            REGISTER_TRAINER,
            CHANGE_LOCALE,
            LOGOUT,
            UPLOAD_IMAGE,
    ...
    public boolean isAccessAllowed(User.UserRole userRole, CommandType commandType) {
        ...
        EnumSet<CommandType> types = roleEnumMap.get(userRole);
        Optional<CommandType> optionalCommandType = types.stream()
