...
public class PagePath {
    ...
    public static final String LOGIN = "jsp/pages/login_sign.jsp";
    public static final String REGISTER = "jsp/pages/register.jsp";
    public static final String VERIFICATION = "jsp/pages/verification.jsp";
    public static final String ERROR = "jsp/pages/err/error.jsp";
    public static final String ERROR_404 = "jsp/pages/err/error404.jsp";
    public static final String ERROR_500 = "jsp/pages/err/error500.jsp";
    ...
    public static final String ADMIN_ORDER_DETAIL = "jsp/pages/admin/admin_order_detail.jsp";
    ...
    public static final String ORDER_UPDATED = "jsp/pages/order_updated.jsp";
    ...
    public static final String SHOW_ALL_TRAINERS = "jsp/pages/client/show_all_trainers.jsp";
