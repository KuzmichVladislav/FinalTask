...
<fmt:message key="comments.edited" bundle="${rb}" var="commentEdited"/>
<fmt:message key="comments.edited.message" bundle="${rb}" var="commentEditedMessage"/>
        ...
        <div class="container register">
            <div class="row">
                ...
                <div class="col-md-9 register-right">
                    <h3 class="register-heading">${commentEdited}</h3>
                    <div class="row register-form">
                        <div class="col-md-6">
                            <p>${commentEditedMessage}</p>
