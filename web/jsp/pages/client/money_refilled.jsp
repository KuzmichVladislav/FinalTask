...
<fmt:message key="money.refilled" bundle="${rb}" var="moneyRefilled"/>
<fmt:message key="money.refilled.message" bundle="${rb}" var="moneyRefilledMessage"/>
...
<div class="container register">
    <div class="row">
        ...
        <div class="col-md-9 register-right">
            <h3 class="register-heading">${moneyRefilled}</h3>
            <div class="row register-form">
                <div class="col-md-6">
                    <p>${moneyRefilledMessage}</p>
