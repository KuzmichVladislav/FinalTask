    ...
    <div class="row">
        ...
        <div class="col-md-9 register-right">
            ...
            <div class="row register-form">
                <div class="col-md-6">
                    <form name="refill_money_form" action="${pageContext.request.contextPath}/controller" method="POST">
                        <input type="hidden" name="command" value="refill_money">
                        <div class="form-group">
                            <label for="input_money"></label>
                            <input type="text" name="money" class="form-control" id="input_money"
                        ...
                        <button type="submit"
                                class="btn btn-primary">${moneyRefill}
                        </button>
                    </form>
                </div>
            </div>
