...
<fmt:message key="user.restored" bundle="${rb}" var="userRestored"/>
<fmt:message key="user.restored.message" bundle="${rb}" var="userRestoredMessage"/>
...
<head>
    ...
    <meta http-equiv="refresh"
          content="5;${pageContext.request.contextPath}/controller?command=SHOW_USERS">
</head>
...
<div class="container register">
    <div class="row">
        ...
        <div class="col-md-9 register-right">
            <h3 class="register-heading">${userRestored}</h3>
            <div class="row register-form">
                <div class="col-md-6">
                    <p>${userRestoredMessage}</p>
