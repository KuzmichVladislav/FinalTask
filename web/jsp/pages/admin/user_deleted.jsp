...
<fmt:message key="user.deleted" bundle="${rb}" var="userDeleted"/>
<fmt:message key="user.deleted.message" bundle="${rb}" var="userDeletedMessage"/>
...
<div class="container register">
    <div class="row">
        ...
        <div class="col-md-9 register-right">
            <h3 class="register-heading">${userDeleted}</h3>
