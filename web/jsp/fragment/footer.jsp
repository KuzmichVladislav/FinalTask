...
<footer class="section footer-classic context-dark bg-image"
        ...
        <div class="row row-30">
            ...
            <div class="col-md-4">
                ...
                <dl class="contact-list">
                    <dt>${footerEmail}</dt>
                    <dd>
                        <a href="mailto:kyzmenoid@gmail.com">fitnessgum@gmail.com</a>
                    </dd>
                </dl>
                <dl class="contact-list">
                    <dt>${footerPhones}</dt>
                    <dd>
                        <a href="tel:#">+375259379992</a> <span>or</span> <a href="tel:#">+375339379992</a>
                    </dd>
                </dl>
            </div>
    ...
    <div class="row no-gutters social-container">
        <div class="col">
            <a class="social-inner" href="https://www.facebook.com/Ktihii"><span
